...
export const BINDINGS = [
  ...
  { control: CONTROL.PREV_UNIT, name: 'PREVIOUS UNIT',    pad: 'L3',     keys: [],                    keyGlyph: 'SHIFT+TAB' },
  { control: CONTROL.NEXT_UNIT, name: 'NEXT UNIT',        pad: 'R3',     keys: [],                    keyGlyph: 'TAB' },
  { control: CONTROL.ZOOM_OUT,  name: 'ZOOM OUT',         pad: 'LT',     keys: ['-'],                 keyGlyph: '-' },
  { control: CONTROL.ZOOM_IN,   name: 'ZOOM IN',          pad: 'RT',     keys: ['='],                 keyGlyph: '+' },
  { control: CONTROL.ROTATE_LEFT,  name: 'ROTATE VIEW',   pad: 'LB',     keys: ['q'],                 keyGlyph: 'Q' },
