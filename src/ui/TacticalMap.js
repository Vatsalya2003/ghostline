...
export class TacticalMap {
  constructor({ squad, fx, fog, state, hazards = null,
  ...
  // rebuilt from the hazard system every frame: one that burns out leaves the
  // map, one that spreads grows on it. The radius is the same reach the smoke
  // uses to occlude a sensor, so the danger area the player is routing around
  // is the one the world actually has.
  syncHazards() {
