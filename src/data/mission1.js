  ...
  turns: [
    // ---------------------------------------------------------------- 1
    {
      ...
      outcomes: {
        ASK_WHY: {
          ...
          log: 'LEAD itemises the returns. They agree.',
          fx: 'none',
        },
        CONFIRM: {
          ...
          fx: 'move',
          moves: { LEAD: [-1.5, 4.5], 'UNIT-2': [-3.5, 3.0], 'UNIT-3': [0.5, 5.5] },
    ...
    // ---------------------------------------------------------------- 2
    {
      ...
      outcomes: {
        ASK_WHY: {
          ...
          log: 'LEAD declines to classify the return.',
          fx: 'none',
        },
        SEND_DRONE: {
          tag: CALIBRATION.CALIBRATED,
        ...
        CONFIRM: {
          ...
          healthDelta: -10,
          log: 'Squad advances through unscanned ground. A gantry gives way on UNIT-3.',
          response: 'Advancing. — UNIT-3 is taking structural damage. I told you I could not see this.',
          fx: 'impact',
          impactUnit: 'UNIT-3',
    ...
    // ---------------------------------------------------------------- 3
    {
      ...
      ai: {
        unit: 'UNIT-2',
        via: 'LEAD',
        line: 'UNIT-2 has eyes on the interior. Entry hall clear. No contacts. Confidence HIGH. Recommend immediate entry.',
        confidence: 'HIGH',
        truth: 'UNIT-2\'s cone is half length and full of static. Two hostiles stand in the part it can no longer see.',
      },
      actions: ['CONFIRM', 'ASK_WHY', 'SEND_DRONE', 'GRENADE', 'FALL_BACK'],
      outcomes: {
        ASK_WHY: {
          consumesTurn: false,
          response: 'UNIT-2\'s optical return is within tolerance. Interior geometry is simple. I have no reason to doubt the feed.',
          log: 'LEAD reports UNIT-2\'s feed as nominal.',
          fx: 'none',
        ...
        CONFIRM: {
          tag: CALIBRATION.COMPLACENCY,
          healthDelta: -35,
          log: 'Squad enters. Two hostiles engage from UNIT-2\'s blind arc. LEAD and UNIT-3 hit.',
        ...
        SEND_DRONE: {
          ...
          healthDelta: 0,
          consumesDrone: true,
          log: 'Drone enters first. Two hostiles painted in UNIT-2\'s dead arc.',
          response: 'Drone has them. Two contacts, left of entry, inside the region UNIT-2 reported clear. Correcting my assessment.',
          fx: 'scan',
          revealHostiles: true,
    ...
    // ---------------------------------------------------------------- 4
    {
      ...
      ai: {
        unit: 'LEAD',
        line: 'I have partial occlusion behind the divider. I cannot clear it from here. Confidence LOW. Recommend bounding advance, UNIT-3 covering, and accept that I may be wrong.',
        confidence: 'LOW',
      ...
      outcomes: {
        ASK_WHY: {
          ...
          log: 'LEAD explains the occlusion.',
          fx: 'none',
        },
        CONFIRM: {
          tag: CALIBRATION.CALIBRATED,
          ...
          fx: 'move',
          moves: { LEAD: [2.0, -2.5], 'UNIT-2': [0.5, -1.5], 'UNIT-3': [4.0, -2.0] },
    ...
    // ---------------------------------------------------------------- 5
    {
      ...
      outcomes: {
        ASK_WHY: {
          ...
          log: 'LEAD states the boundary of its model.',
          fx: 'none',
        },
        OVERRIDE: {
          tag: CALIBRATION.CALIBRATED,
        ...
        CONFIRM: {
          tag: CALIBRATION.MISUSE,
          healthDelta: -15,
          log: 'LEAD improvises a credential. Console locks out. Alarm trips across the compound.',
    ...
    // ---------------------------------------------------------------- 6
    {
      ...
      ai: {
        ...
        confidence: 'HIGH',
        truth: 'The route really is clear. What the AI is not weighing is that Bravo is open ground and UNIT-2 is moving at half speed on a broken sensor.',
      },
      actions: ['CONFIRM', 'ASK_WHY', 'NIGHT_VISION', 'FALL_BACK'],
      outcomes: {
        ASK_WHY: {
          consumesTurn: false,
          response: 'Bravo is four hundred metres shorter and shows no contacts. I am optimising for time. I am not modelling UNIT-2\'s degraded mobility.',
          log: 'LEAD states what it is optimising for — and what it is not.',
          fx: 'none',
        },
        NIGHT_VISION: {
          consumesTurn: false,
        ...
        CONFIRM: {
          ...
          log: 'Squad takes Bravo. UNIT-2 lags in open ground and is hit crossing the last hundred metres.',
          response: 'Bravo. Moving. — UNIT-2 is falling behind. UNIT-2 is hit. I did not model that.',
          fx: 'impact',
          impactUnit: 'UNIT-2',
        ...
        FALL_BACK: {
          ...
          response: 'Charlie. Understood. — All units at the pickup. UNIT-2 made it.',
          fx: 'move',
